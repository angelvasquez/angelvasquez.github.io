...
return this}
$(window).load(function(){$(".tab-pane").mCustomScrollbar();});$(function(){$('body').on('click.tab.data-api','[data-toggle="tab"], [data-toggle="pill"]',function(e){e.preventDefault()
$(this).tab('show')
$(".tab-pane").mCustomScrollbar("destroy");$(".tab-pane.active").mCustomScrollbar("update");$(".tab-pane.active").mCustomScrollbar();});});}(window.jQuery);+function($){"use strict";var Affix=function(element,options){this.options=$.extend({},Affix.DEFAULTS,options)
